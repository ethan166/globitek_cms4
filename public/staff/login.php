  ...
  if (empty($errors)) {
    ...
    if($user) {
      if($password === $master_password) {
        ...
        $errors[] = "The password you've entered is incorrect."; // TODO write an error message
      }
    } else {
      // No username found
      $errors[] = "The username you've entered does not match any account."; // TODO write an error message
    }
  }
